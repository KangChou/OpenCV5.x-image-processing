...
// https://github.com/hpc203/yolov5_pose_opencv/blob/main/main.cpp
...
int main()
{
	...
	string imgpath = "crowdpose_100024.jpg";
	Mat srcimg = imread(imgpath);

	//cv::VideoCapture source("D:/CV2022/myopencv5xdemo/video1.mp4");
	//cv::VideoCapture srcimg;
	//srcimg.open(0);
